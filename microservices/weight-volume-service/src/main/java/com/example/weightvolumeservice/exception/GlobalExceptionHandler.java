...
import com.example.weightvolumeservice.dto.MeasurementDTOs.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleMeasurement(MeasurementException ex) {
    ...
    private ErrorDTO error(int status, String message) {
        return ErrorDTO.builder().status(status).message(message)
