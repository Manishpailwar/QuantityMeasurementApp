package com.example.temperatureservice.security;

import com.example.temperatureservice.exception.UnauthorizedException;
...
/**
 * Delegates JWT validation to the Auth Service.
 * Returns the authenticated userId or throws UnauthorizedException.
 */
@Component
