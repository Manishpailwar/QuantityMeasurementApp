...
import com.example.lengthservice.dto.LengthDTOs.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(LengthMeasurementException.class)
    public ResponseEntity<ErrorDTO> handleMeasurement(LengthMeasurementException ex) {
