package com.example.lengthservice.security;

import com.example.lengthservice.exception.UnauthorizedException;
...
/**
 * Calls the Auth Service to validate incoming JWT tokens.
 * Returns the userId extracted from the token, or throws UnauthorizedException.
 */
@Component
